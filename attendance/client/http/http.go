...
import (
	...
	http1 "net/http"
	"net/url"
	endpoint1 "om-kit/attendance/pkg/endpoint"
	http2 "om-kit/attendance/pkg/http"
	service "om-kit/attendance/pkg/service"
	"strings"
)
...
func New(instance string, options map[string][]http.ClientOption) (service.AttendanceService, error) {
