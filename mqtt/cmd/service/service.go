...
import (
	...
	"net"
	http1 "net/http"
	endpoint "om-kit/mqtt/pkg/endpoint"
	http "om-kit/mqtt/pkg/http"
	service "om-kit/mqtt/pkg/service"
	"os"
	"os/signal"
...
var fs = flag.NewFlagSet("mqtt", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "mqtt")
