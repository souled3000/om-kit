...
import (
	...
	http1 "net/http"
	"net/url"
	endpoint1 "om-kit/queue/pkg/endpoint"
	http2 "om-kit/queue/pkg/http"
...
func New(instance string, options map[string][]http.ClientOption) (service.QueueService, error) {
