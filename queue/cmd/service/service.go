...
import (
	...
	"net"
	http1 "net/http"
	endpoint "om-kit/queue/pkg/endpoint"
	http "om-kit/queue/pkg/http"
	service "om-kit/queue/pkg/service"
	"os"
	"os/signal"
...
var fs = flag.NewFlagSet("queue", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "queue")
