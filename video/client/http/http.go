...
import (
	...
	http1 "net/http"
	"net/url"
	endpoint1 "om-kit/video/pkg/endpoint"
	http2 "om-kit/video/pkg/http"
...
func New(instance string, options map[string][]http.ClientOption) (service.VideoService, error) {
