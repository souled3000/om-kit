...
import (
	...
	"net"
	http1 "net/http"
	endpoint "om-kit/video/pkg/endpoint"
	http "om-kit/video/pkg/http"
	service "om-kit/video/pkg/service"
	"os"
	"os/signal"
...
var fs = flag.NewFlagSet("video", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "video")
