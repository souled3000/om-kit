...
import (
	...
	http1 "net/http"
	"net/url"
	endpoint1 "om-kit/report/pkg/endpoint"
	http2 "om-kit/report/pkg/http"
	service "om-kit/report/pkg/service"
	"strings"
)
...
func New(instance string, options map[string][]http.ClientOption) (service.ReportService, error) {
