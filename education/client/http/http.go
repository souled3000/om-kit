...
import (
	...
	http1 "net/http"
	"net/url"
	endpoint1 "om-kit/education/pkg/endpoint"
	http2 "om-kit/education/pkg/http"
...
func New(instance string, options map[string][]http.ClientOption) (service.EducationService, error) {
