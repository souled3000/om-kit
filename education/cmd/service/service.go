...
import (
	...
	"net"
	http1 "net/http"
	endpoint "om-kit/education/pkg/endpoint"
	http "om-kit/education/pkg/http"
	service "om-kit/education/pkg/service"
	"os"
	"os/signal"
...
var fs = flag.NewFlagSet("education", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "education")
