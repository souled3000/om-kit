...
import (
	...
	http1 "net/http"
	"net/url"
	endpoint1 "om-kit/onemore/pkg/endpoint"
	http2 "om-kit/onemore/pkg/http"
	service "om-kit/onemore/pkg/service"
	"strings"
)
...
func New(instance string, options map[string][]http.ClientOption) (service.OnemoreService, error) {
