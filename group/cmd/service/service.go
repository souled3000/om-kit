...
import (
	...
	"net"
	http1 "net/http"
	endpoint "om-kit/group/pkg/endpoint"
	http "om-kit/group/pkg/http"
	service "om-kit/group/pkg/service"
	"os"
	"os/signal"
...
var fs = flag.NewFlagSet("group", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "group")
