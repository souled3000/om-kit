...
import (
	...
	http1 "net/http"
	"net/url"
	endpoint1 "om-kit/group/pkg/endpoint"
	http2 "om-kit/group/pkg/http"
...
func New(instance string, options map[string][]http.ClientOption) (service.GroupService, error) {
