...
import (
	...
	"net"
	http1 "net/http"
	endpoint "om-kit/kindergarten/pkg/endpoint"
	http "om-kit/kindergarten/pkg/http"
	service "om-kit/kindergarten/pkg/service"
	"os"
	"os/signal"
...
var fs = flag.NewFlagSet("kindergarten", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "kindergarten")
