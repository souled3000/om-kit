...
import (
	...
	http1 "net/http"
	"net/url"
	endpoint1 "om-kit/kindergarten/pkg/endpoint"
	http2 "om-kit/kindergarten/pkg/http"
...
func New(instance string, options map[string][]http.ClientOption) (service.KindergartenService, error) {
