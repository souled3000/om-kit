...
import (
	...
	http1 "net/http"
	"net/url"
	endpoint1 "om-kit/seedling/pkg/endpoint"
	http2 "om-kit/seedling/pkg/http"
...
func New(instance string, options map[string][]http.ClientOption) (service.SeedlingService, error) {
