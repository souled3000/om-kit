...
import (
	...
	"net"
	http1 "net/http"
	endpoint "om-kit/seedling/pkg/endpoint"
	http "om-kit/seedling/pkg/http"
	service "om-kit/seedling/pkg/service"
	"os"
	"os/signal"
...
var fs = flag.NewFlagSet("seedling", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "seedling")
