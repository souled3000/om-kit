...
import (
	...
	http1 "net/http"
	"net/url"
	endpoint1 "om-kit/healthy/pkg/endpoint"
	http2 "om-kit/healthy/pkg/http"
...
func New(instance string, options map[string][]http.ClientOption) (service.HealthyService, error) {
