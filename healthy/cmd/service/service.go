...
import (
	...
	"net"
	http1 "net/http"
	endpoint "om-kit/healthy/pkg/endpoint"
	http "om-kit/healthy/pkg/http"
	service "om-kit/healthy/pkg/service"
	"os"
	"os/signal"
...
var fs = flag.NewFlagSet("healthy", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "healthy")
