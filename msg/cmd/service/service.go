...
import (
	...
	"net"
	http1 "net/http"
	endpoint "om-kit/msg/pkg/endpoint"
	http "om-kit/msg/pkg/http"
	service "om-kit/msg/pkg/service"
	"os"
	"os/signal"
...
var fs = flag.NewFlagSet("msg", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "msg")
