...
import (
	...
	"net"
	http1 "net/http"
	endpoint "om-kit/activity/pkg/endpoint"
	http "om-kit/activity/pkg/http"
	service "om-kit/activity/pkg/service"
	"os"
	"os/signal"
...
var fs = flag.NewFlagSet("activity", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "activity")
