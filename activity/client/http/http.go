...
import (
	...
	http1 "net/http"
	"net/url"
	endpoint1 "om-kit/activity/pkg/endpoint"
	http2 "om-kit/activity/pkg/http"
...
func New(instance string, options map[string][]http.ClientOption) (service.ActivityService, error) {
