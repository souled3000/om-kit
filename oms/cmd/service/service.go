...
import (
	...
	"net"
	http1 "net/http"
	endpoint "om-kit/oms/pkg/endpoint"
	http "om-kit/oms/pkg/http"
	service "om-kit/oms/pkg/service"
	"os"
	"os/signal"
...
var fs = flag.NewFlagSet("oms", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "oms")
