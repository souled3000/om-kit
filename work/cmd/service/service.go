...
import (
	...
	"net"
	http1 "net/http"
	endpoint "om-kit/work/pkg/endpoint"
	http "om-kit/work/pkg/http"
	service "om-kit/work/pkg/service"
	"os"
	"os/signal"
...
var fs = flag.NewFlagSet("work", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "work")
