...
import (
	...
	http1 "net/http"
	"net/url"
	endpoint1 "om-kit/material_pack/pkg/endpoint"
	http2 "om-kit/material_pack/pkg/http"
...
func New(instance string, options map[string][]http.ClientOption) (service.MaterialPackService, error) {
