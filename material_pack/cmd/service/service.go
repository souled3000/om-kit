...
import (
	...
	"net"
	http1 "net/http"
	endpoint "om-kit/material_pack/pkg/endpoint"
	http "om-kit/material_pack/pkg/http"
	service "om-kit/material_pack/pkg/service"
	"os"
	"os/signal"
...
var fs = flag.NewFlagSet("material_pack", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "material_pack")
