...
import (
	...
	"net"
	http1 "net/http"
	endpoint "om-kit/material/pkg/endpoint"
	http "om-kit/material/pkg/http"
	service "om-kit/material/pkg/service"
	"os"
	"os/signal"
...
var fs = flag.NewFlagSet("material", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "material")
