...
import (
	...
	http1 "net/http"
	"net/url"
	endpoint1 "om-kit/courseware/pkg/endpoint"
	http2 "om-kit/courseware/pkg/http"
...
func New(instance string, options map[string][]http.ClientOption) (service.CoursewareService, error) {
