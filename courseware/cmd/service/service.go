...
import (
	...
	"net"
	http1 "net/http"
	endpoint "om-kit/courseware/pkg/endpoint"
	http "om-kit/courseware/pkg/http"
	service "om-kit/courseware/pkg/service"
	"os"
	"os/signal"
...
var fs = flag.NewFlagSet("courseware", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "courseware")
